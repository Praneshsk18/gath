...
function App() {
  ...
  return (
    <div className="flex flex-col items-center h-full min-h-screen w-full">
      <div className="fixed top-0 -z-10 left-0 bg-[url('https://storage.123fakturera.se/public/wallpapers/sverige43.jpg')] bg-cover bg-center bg-fixed h-[100vh] w-full"></div>
