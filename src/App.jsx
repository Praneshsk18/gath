...
function App() {
  ...
  return (
    <div className="flex flex-col items-center min-h-screen max-h-screen w-full bg-[url('https://storage.123fakturera.se/public/wallpapers/sverige43.jpg')] bg-cover bg-center bg-fixed">
